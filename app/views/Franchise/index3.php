                        ...
                        <tr>
                            ...
                            <th>
                                <div class="form-outline">
                                    <textarea disabled name='' id='' cols='50' rows='4'>  <?= $franchise['alamat'] . " Desa/Kelurahan " . $franchise['desa'] . ", Kecamatan " . $franchise['kecamatan'] . ", " . $franchise['kabupaten'] . ", Provinsi " . $franchise['provinsi'] ?></textarea>
                                </div>
                            </th>
                        </tr>
                    <?php
