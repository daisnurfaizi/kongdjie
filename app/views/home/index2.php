      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-sm-6 paragraf">
            ...
            <a href="" class="btn viewdetail" data-toggle="modal" data-target="#exampleModal"> View Detail </a>
      ...
      <div class="container text-center">
        ...
        <div class="row tekswilayah justify-content-center">
          <div class="col-4 text-left">
            <a class="wilayah1" href="#">DKI JAKARTA</a>
...
>>>>>>> 09ef78402426e3a9c9422681900cd191bb853806
  ...
  <script src="<?= BASEURL, PORT, LOCATION; ?>/js/kongdjie.js"></script>
  <script>
    function cintatakterbalas() {
