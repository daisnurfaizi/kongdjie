...
<html lang="en">
  ...
  <body>
      ...
      <div class="jumbotron jumbotron-fluid">
        <div class="container text-center">
          ...
          <div class="row">
            ...
            <!-- <div class="ornamen">
              <<?= BASEURL, PORT, LOCATION ?>/img src="img/Bijay Coffe Back Atas.png">
            </div>    
            <div class="ornamen1">
              <<?= BASEURL, PORT, LOCATION ?>/img src="img/Bijay Coffe Back Bawah.png">
            </div>  -->
        </div>
      </div>
    </section>
      ...
      <div class="container text-center">
        ...
        <div class="row tekswilayah justify-content-center">
          <div class="col-4 text-left">
            ...
            <a class="wilayah1" href="<?= BASEURL, LOCATION, PORT ?>/Franchise/Riau">KEP. RIAU</a>
          </div>
          <div class="col-4 text-right">
            <a class="wilayah2" href="<?= BASEURL, LOCATION, PORT ?>/Franchise/KEPULAUAN-BANGKA-BELITUNG">KEP. BANGKA</a>
            ...
            <a class="wilayah2" href="<?= BASEURL, LOCATION, PORT ?>/Franchise/MALUKU-UTARA">PAPUA BARAT</a>
    ...
    <script> scr="<?= BASEURL, PORT, LOCATION ?>/js/jquery-3.6.0.min.js" </script>
    <script> scr="<?= BASEURL, PORT, LOCATION ?>/js/KongDjie.js" </script>
